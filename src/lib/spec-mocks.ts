...
export const topOffers: OfferCard[] = [
  {
    ...
    matchClass: "direct",
    why: "Going your way on your requested timing window",
    fit: "Likely fits",
    total: "$95",
  ...
  },
  {
    ...
    schedule: "Sun midday",
    matchClass: "direct",
    why: "Going your way with a flexible drop-off window",
    fit: "Review photos",
    total: "$110",
...
export const nearbyDateOffers: OfferCard[] = [
  {
    ...
    matchClass: "partial",
    why: "Good match for your move — available within 3 days",
    fit: "Likely fits",
    total: "$98",
  },
];
