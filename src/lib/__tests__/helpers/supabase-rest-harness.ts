...
export function createBookingRow(
  ...
  return {
    ...
    needs_stairs: false,
    needs_helper: false,
    customer_mover_preference: "one_mover" as const,
    stairs_level_pickup: "none" as const,
    stairs_level_dropoff: "none" as const,
    lift_available_pickup: false,
    lift_available_dropoff: false,
    second_mover_fee_cents: 0,
