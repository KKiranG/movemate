...
export const demoTrips: Trip[] = [
  {
    ...
    route: {
      ...
      waypoints: [{ suburb: "Parramatta" }, { suburb: "Strathfield" }],
    ...
    detourRadiusKm: 15,
    detourTolerance: "flexible",
    priceCents: 8500,
    minimumBasePriceCents: 1000,
    ...
    rules: {
      ...
      stairsLowCents: 2000,
      stairsMediumCents: 3500,
      stairsHighCents: 5000,
  ...
  },
  {
    ...
    rules: {
      ...
      helperExtraCents: 0,
      handlingPolicy: "solo_only" as const,
      stairsLowCents: 0,
      stairsMediumCents: 0,
      stairsHighCents: 0,
      secondMoverExtraCents: 0,
  ...
  },
  {
    ...
    route: {
      ...
      waypoints: [{ suburb: "Newtown" }, { suburb: "Lidcombe" }],
    ...
    rules: {
      ...
      handlingPolicy: "solo_only" as const,
      stairsLowCents: 1500,
      stairsMediumCents: 2500,
      stairsHighCents: 4000,
      secondMoverExtraCents: 0,
