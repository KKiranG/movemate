...
| `backlog-groomer` | backlog audits, task-quality cleanup, duplicate or stale task review | `TASK-RULES.md`, `.claude/task-template.md`, `docs/operations/docs/operations/todolist.md` |
