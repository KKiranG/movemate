...
when_to_use: Use when the user wants to add, rewrite, split, or tighten a backlog item in `docs/operations/todolist.md`.
...
3. The relevant section of `docs/operations/todolist.md`
...
Ask the user to confirm the draft before editing `docs/operations/todolist.md`.
