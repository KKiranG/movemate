...
Then read:
1. `docs/operations/docs/operations/todolist.md` — top uncompleted item by priority
...
Before stopping:
- [ ] Completed items moved from `docs/operations/docs/operations/todolist.md` to `docs/operations/docs/operations/completed.md`
- [ ] `npm run check` passes if code was touched
- [ ] Docs synced if behavior, routes, or commands changed
- [ ] New follow-up tasks added to `docs/operations/docs/operations/todolist.md` with proper IDs
